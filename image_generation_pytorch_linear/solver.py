...
class Solver(object):
    ...
    def build_model(self):
        ...
        if self.data_loader is not None:
            print("  dataset:", type(self.data_loader.dataset).__name__)
        else:
        ...
        print("  use_spectral_norm:", self.discriminator.use_spectral_norm)
        ...
        self.save_generator_config()
        self.save_discriminator_config()
    
    def save_generator_config(self):
        ...
        config = {
            "generator": {
                ...
                "output_activation": (
                    self.generator.output_activation.__class__.__name__
                ),
            },
        ...
        print("Generator configuration saved to:", config_path)

    def save_discriminator_config(self):
        """
        Save the discriminator architecture and training settings
        ...
        config = {
            "discriminator": {
                ...
                "use_spectral_norm": (
                    self.discriminator.use_spectral_norm
                ),
                ...
                "trainable_parameters": disc_params,
            },

            "layer_shapes": {
                "layer_1": {
                    "input_features": self.discriminator.input_dim,
                    "output_features": self.discriminator.hidden_dim,
                },
                "layer_2": {
                    "input_features": self.discriminator.hidden_dim,
                    "output_features": self.discriminator.hidden_dim,
                },
                "layer_3": {
                    "input_features": self.discriminator.hidden_dim,
        ...
        print(
            "Discriminator configuration saved to:",
            config_path
        )
